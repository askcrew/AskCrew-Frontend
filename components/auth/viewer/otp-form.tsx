        ...
        <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-10">
          ...
          <div className="mb-8 text-center">
            ...
            <p className="text-gray-500 text-sm">
              Enter OTP which had been sent to you on your email account to set
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            {/* Email Address */}
            <OTPInput
              groupClassName="md:gap-6 gap-2"
              className="border border-gray-300 rounded-lg flex-1 aspect-square"
              onChange={(value) => {
                console.log(value);
              }}
            />
