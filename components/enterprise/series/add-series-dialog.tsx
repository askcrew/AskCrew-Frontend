...
import { IconPlus, IconBrandCinema4d } from "@tabler/icons-react";
        ...
        <DialogHeader className="space-y-3 border-b pb-4">
          <div className="flex items-center gap-3">
            <div className="p-2 rounded-lg bg-linear-to-br from-orange-500/20 to-purple-500/20 border border-orange-500/30">
              <IconBrandCinema4d className="size-6 text-orange-500" />
            </div>
          ...
          <DialogDescription className="text-base">
            Create a new series by providing the title, description, cover
            photo, and category.
          </DialogDescription>
        </DialogHeader>

        <SeriesForm  onCancel={() => setOpen(false)}  />
      </DialogContent>
    </Dialog>
  );
}
